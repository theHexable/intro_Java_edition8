 ...
 * @author Shady Bajary
 * @Exercise 7.9
 * @Title Game: playing a TicTacToe game
...
public class Exercise7_09 {
    ...
    /**
     * isVerticalWin returns true if player has placed three tokens in a
     * vertical row
     */
    ...
    /**
     * isDiagonalWin returns true if player has placed three tokens in a
     * diagonal row
     */
    ...
    /**
     * isDraw returns true if all the cells on the grid have been filled with
     * tokens and neither player has achieved a win
     */
